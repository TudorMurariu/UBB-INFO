...
err=eps;
tic
[z1,x1,n1]=Jacobit(A,b,b,err,1000);
[z2,x2,n2]=relaxt(A,b,1,b,err,1000);
[z3,x3,n3]=relaxt(A,b,w,b,err,1000);
toc
clear r*
r1=kron(ones(1,n1+1),b)-A*x1(:,1:n1+1);
r2=kron(ones(1,n2+1),b)-A*x2(:,1:n2+1);
r3=kron(ones(1,n3+1),b)-A*x3(:,1:n3+1);
for k=1:n1+1
